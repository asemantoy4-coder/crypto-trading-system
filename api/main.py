...
# Method 1: Try direct import from same directory
try:
    # Since utils.py is in the same directory (api/)
    import utils as utils_module
    utils = utils_module
    UTILS_AVAILABLE = True
    print("✅ SUCCESS: Utils imported via direct import")
except ImportError as e:
    print(f"❌ Method 1 failed: {e}")
    
    # Method 2: Try importing individual functions
    try:
        ...
        UTILS_AVAILABLE = True
        print("✅ SUCCESS: Individual functions imported")
    except ImportError as e:
...
# ==============================================================================
# Mock Functions (Fallback if utils not available)
# ==============================================================================
...
if UTILS_AVAILABLE:
    ...
    # Assign real functions from utils module
