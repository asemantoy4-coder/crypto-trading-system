...
import logging
from typing import List, Optional, Dict, Any  # ✅ همه type hints لازم
import random
import sys
import os
import math
...
# ==============================================================================
# 1. تابع محاسبه تارگت را در ابتدای فایل قرار دهید (قبل از mock functions)
# ==============================================================================
...
if UTILS_AVAILABLE:
    ...
    try:
        ...
        # Try to get functions from utils module directly
        try:
            ...
            print("✅ Functions retrieved from utils module")
        except AttributeError as e:
            print(f"❌ Failed to get functions from utils: {e}")
            UTILS_AVAILABLE = False
...
# ==============================================================================
# 2. اصلاح تابع mock_analyze_with_multi_timeframe_strategy
# ==============================================================================
...
# ==============================================================================
# Function Selection Logic (WITH WRAPPER FUNCTIONS)
# ==============================================================================
...
if UTILS_AVAILABLE:
    ...
    def get_swing_high_low_wrapper(data, lookback=20):
        """Wrapper for get_swing_high_low."""
        return get_swing_high_low(data, period=lookback)
    
    def calculate_smart_entry_wrapper(data, signal="BUY", strategy="ICHIMOKU_FIBO"):
        """Wrapper for calculate_smart_entry."""
        return calculate_smart_entry(data, signal=signal, strategy=strategy)
    
    def get_support_resistance_levels_wrapper(data):
        """Wrapper for get_support_resistance_levels."""
        return get_support_resistance_levels(data)
    
    def calculate_volatility_wrapper(data, period=20):
        """Wrapper for calculate_volatility."""
        return calculate_volatility(data, period=period)
    
    # Assign wrapper functions
    get_swing_high_low_func = get_swing_high_low_wrapper
    calculate_smart_entry_func = calculate_smart_entry_wrapper
    get_support_resistance_levels_func = get_support_resistance_levels_wrapper
    calculate_volatility_func = calculate_volatility_wrapper
...
# ==============================================================================
# 3. اصلاح تابع analyze_ichimoku_scalp
# ==============================================================================
...
async def get_scalp_signal(request: ScalpRequest):
    ...
    # ==============================================================================
    # 5. اصلاح fallback در /api/scalp-signal
    # ==============================================================================
...
async def get_ichimoku_scalp_signal(request: IchimokuRequest):
    ...
    try:
        ...
        # استفاده از مقادیر از ichimoku_analysis که قبلاً محاسبه شده
        return {
            "symbol": request.symbol,
            "timeframe": request.timeframe,
